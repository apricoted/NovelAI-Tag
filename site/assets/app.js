import { state, RECENT_STORAGE_KEY, LAST_BROWSE_STORAGE_KEY, NSFW_STORAGE_KEY, R18G_STORAGE_KEY, DENSITY_STORAGE_KEY } from './app/state.js?v=20260702-cache15';
import { $, esc, safeJsonParse, updateSearchClear, prefersReducedMotion } from './app/utils.js?v=20260702-cache15';
import { setLoading, showSkeleton, hideSkeleton } from './app/feedback.js?v=20260702-cache15';
import { isCodexLocked, firstUnlockedCodex, showNsfwLockedHint, isEntryAccessBlocked, isR18gPath } from './app/access.js?v=20260702-cache15';
import { loadMedia, loadAbout, fetchCodex, findCodexMeta, notifyCodexDataStatus } from './app/data.js?v=20260702-cache15';
import { parseSearchQuery, matchSearchPlan } from './app/search.js?v=20260702-cache15';
import { hasEntryImage, primeResourceHints } from './app/media.js?v=20260702-cache15';
import { isFav, setFavoritesActions, toggleFav } from './app/favorites.js?v=20260702-cache15';
import { renderList, clearMasonry, updateVirtualCards, setMasonryActions } from './app/masonry.js?v=20260702-cache15';
import { openLightbox } from './app/lightbox.js?v=20260702-cache15';
import { copyEntry } from './app/copy.js?v=20260702-cache15';
import { openReportDialog } from './app/report.js?v=20260702-cache15';
import { readUrlState, syncUrlState, openEntryDeepLink, setRouterActions } from './app/router.js?v=20260702-cache15';
import { setupCodexPicker, setupAbout, updateCodexPickerState, renderTree, renderCodexHeader, updateRailActive, updateResultBar, updateEmptyState, setCodexUiActions } from './app/codex-ui.js?v=20260702-cache15';
import { normalizeRecentEntries, normalizeLastBrowse, scheduleBrowseStateSave, suppressBrowseStateSave, setHistoryActions } from './app/history.js?v=20260702-cache15';
import { bindUI, applyDensity, setUiActions } from './app/ui.js?v=20260702-cache15';
import { maybeShowOnboarding } from './app/onboarding.js?v=20260702-cache15';
