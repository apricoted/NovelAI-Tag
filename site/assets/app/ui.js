import { state, DENSITY_PRESETS, DENSITY_STORAGE_KEY, THEME_STORAGE_KEY, THEMES, NSFW_STORAGE_KEY, R18G_STORAGE_KEY } from './state.js?v=20260702-cache16';
import { normalizeDensity, densityConfig } from './state.js?v=20260702-cache16';
import { $, updateSearchClear, updateScrollProgress, prefersReducedMotion } from './utils.js?v=20260702-cache16';
import { toast } from './feedback.js?v=20260702-cache16';
import { firstUnlockedCodex, isNsfwCodex, isNsfwPathSegment, isR18gName } from './access.js?v=20260702-cache16';
import { closeBannerAbout, renderCodexArchive, renderTree, renderCodexHeader, randomExplore, updateCodexPickerState } from './codex-ui.js?v=20260702-cache16';
import { syncUrlState } from './router.js?v=20260702-cache16';
import { renderHistoryPanel, resumeLastBrowse, openRecentEntry, saveRecentEntries, scheduleBrowseStateSave } from './history.js?v=20260702-cache16';
import { captureMasonryAnchor, restoreMasonryAnchor, relayoutVisible, updateVirtualCards, scheduleVirtualUpdate, scheduleRelayout } from './masonry.js?v=20260702-cache16';
import { bindLightboxControls } from './lightbox.js?v=20260702-cache16';
import { openMask, closeMask, trapFocus } from './modal.js?v=20260702-cache16';
import { setupAnnouncements } from './announcements.js?v=20260702-cache16';
import { setupReport, openReportDialog } from './report.js?v=20260702-cache16';
import { setupOnboarding } from './onboarding.js?v=20260702-cache16';
