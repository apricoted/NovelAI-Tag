...
| `ui.js` | `setUiActions`, density orchestration, global UI binding | `uiActions`, `THEME_ICONS` | `state.js`, `utils.js`, `feedback.js`, `access.js`, `codex-ui.js`, `masonry.js`, `router.js`, `history.js`, `lightbox.js`, `modal.js`, `announcements.js`, `report.js`, `onboarding.js` | `loadCodex`, `applyFilter` |
