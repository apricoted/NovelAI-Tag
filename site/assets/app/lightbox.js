...
import { $, clamp, esc, prefersReducedMotion } from './utils.js?v=20260702-cache6';
import { notifyImageLoadError } from './masonry.js?v=20260702-cache6';
import { renderHighlightedText, currentHighlightTerms } from './search.js?v=20260702-cache6';
import { copyText, combinedPrompt } from './copy.js?v=20260702-cache6';
import { toast } from './feedback.js?v=20260702-cache6';
import { recordRecentEntry } from './history.js?v=20260702-cache6';
import { syncUrlState } from './router.js?v=20260702-cache6';
import { entryImages, imageItemUrl } from './media.js?v=20260702-cache6';
import { isEntryAccessBlocked, isR18gBlocked, needsR18gReveal, showNsfwLockedHint, showR18gLockedHint } from './access.js?v=20260702-cache6';
import { openReportDialog } from './report.js?v=20260702-cache6';
